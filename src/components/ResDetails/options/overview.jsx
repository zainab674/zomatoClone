            ...
            <div className=" flex ">
                ...
                <div className="w-2/3 p-4">
                    ...
                    <div className="flex space-x-4 mb-6">
                        <button className="flex items-center  border rounded-lg bg-white shadow-md w-full">
                            <img src="https://cdn-icons-png.flaticon.com/512/577/577994.png" alt="Well Sanitized Kitchen" className="w-12 h-12 rounded-full mr-4" />
                        ...
                        <button className="flex items-center border rounded-lg bg-white shadow-md w-full">
                            <img src="https://e7.pngegg.com/pngimages/331/282/png-clipart-hand-washing-symbol-sign-symbol-miscellaneous-blue.png" alt="Rider Hand Wash" className="w-12 h-12 rounded-full mr-4" />
                            <div className="flex-1">
                                <p className="text-xs whitespace-nowrap ">Restaurant safety measure</p>
                                <p className="text-sm ">Rider Hand Wash</p>
                            </div>
                        </button>
                        <button className="flex items-center p-4 border rounded-lg bg-white shadow-md w-full">
                            <img src="https://media.istockphoto.com/id/1214364766/vector/checking-body-temperature-line-icon-coronavirus-and-covid-19-temperature-scaning-sign-vector.jpg?s=612x612&w=0&k=20&c=KbgsTLh0Vb_9LIy8sCOkjwouWSmzGbeaOJ4y6J0HQ8s=" alt="Daily Temp. Checks" className="w-12 h-12 rounded-full mr-4" />
                            <div className="flex-1">
                                <p className="text-xs whitespace-nowrap">RESTAURANT SAFETY MEASURE</p>
                                <p className="text-sm ">Daily Temp. </p>
                            </div>
                        </button>
                    </div>
                    ...
                    <div className="mb-6">
                        ...
                        <div className="flex items-center">
                            <img src={card.menu[0]} alt="Food Menu" className="w-32 h-32 object-cover mr-4" />
                    ...
                    <div className="mb-6">
                        ...
                        <div className="flex space-x-2">
                            ...
                            {card.cuisines.map((cuisine, index) => (
                                <span key={index}>
                                    <span className="px-4 py-2 border border-blue-500 text-blue-500 rounded-full">{cuisine}</span>
                    ...
                    <div className="mb-6 mt-10">
                        ...
                        <div className="flex space-x-2 texxt-sm">



                            {card.reviewCategory.map((cat, index) => (
                                <span key={index}>
                                    <span className="p-2 text-gray-700 rounded-full border border-gray-200 font-light">{cat}</span>
                    ...
                    <p className='text-red-600 hover:cursor-pointer'>View all reviews</p>
                ...
                {/* Right Section */}
                <div className="w-1/3 p-4 mt-10 bg-gray-100">
